...
{M2}    //////   ' \/ `   ---
{M2}   //// / // :    : ---          {P2}➣ Create By ArynzClem   
{P2}  // /   /  /`    '--            {P2}➣ Version 0.3   
{P2} //          //..\\              {P2} ➣ Made By MUSLIM CYBER ARMY    
{P2}       ====UU====UU=====	 {P2}➣ Github : https://github.com/ArynzClem
{P2}            '//||\\`
{P2}             ''``'' '''
...
def login():
	...
	cetak(nel(f'   {P2}Hi! Sepertinya Kamu Adalah Pengguna Baru. Terima Kasih Telah Memilih Tools Ini Sebagai Pilihan Terpercayamu. Sebelum Menggunakan Tools Ini, Kamu Harus Login Terlebih Dahulu! Jangan Lupa Berikan Penilaian Terbaik Di Github Ya! Dan Subs My Channel Thank You!\n\n                {H2}- ArynzClem -',title=f'{P2} {H2}[ {P2}Welcome User {H2}]',width=54,padding=(1,4),style='green'))
	...
	try:
		...
		for x in range(jumlah):
			...
			if "id" in post:
				...
				print(f'{P}\r   └──> {ArynzClem} Successfully shared   {H}{n}{P} post.{N} ',end='');sys.stdout.flush()
			else:
				print("\n")
